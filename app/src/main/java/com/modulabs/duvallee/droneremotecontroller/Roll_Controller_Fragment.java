...
public class Roll_Controller_Fragment extends Fragment implements View.OnClickListener
{
    ...
    @Override public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        int aux1_min = droneProtocol.get_channel_min_value();
        int aux1_value = droneProtocol.get_channel_default_value();
        int aux1_max = droneProtocol.get_channel_max_value();
        ...
        m_aux2_seekbar_test.setOnRangeSeekBarChangeListener(new RangeSeekBar.OnRangeSeekBarChangeListener<Integer>()
        {
            ...
            public void onRangeSeekBarValuesChanged(RangeSeekBar<?> bar, Integer minValue, Integer maxValue, Integer Value)
            {
                ...
                droneProtocol.set_ch2_value(Value);
        ...
        int aux2_min = droneProtocol.get_channel_min_value();
        int aux2_value = droneProtocol.get_channel_default_value();
        int aux2_max = droneProtocol.get_channel_max_value();
        ...
        int roll_min = droneProtocol.get_channel_min_value();
        int roll_value = droneProtocol.get_channel_default_value();
        int roll_max = droneProtocol.get_channel_max_value();
